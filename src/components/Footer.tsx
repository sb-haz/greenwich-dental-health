      ...
      <div className="border-b border-white/10 px-5 py-10 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
          <span className="inline-block rounded-lg bg-white px-3 py-2">
            <Image src={site.logo} alt="Greenwich Dental Health" width={220} height={64} className="h-auto max-h-14 w-auto" />
          </span>
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 lg:grid-cols-4 lg:px-8">
        <div className="lg:col-span-2">
          <p className="type-body-sm text-white/75">
            Award-winning private dentistry in Greenwich. Friendly team, transparent fees, modern technology.
          </p>
        </div>
        <div>
